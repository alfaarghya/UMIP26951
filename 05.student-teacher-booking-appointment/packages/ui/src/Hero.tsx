...
const Hero = () => {
  ...
  return (
    <section className="w-full h-full flex flex-col justify-center items-center text-center py-20 pt-30 bg-gradient-to-b from-blue-500 to-white">
      <div className="m-5">
      ...
      <button
        onClick={() => role === "" ? router.push("/signin") : router.push("/dashboard")}
