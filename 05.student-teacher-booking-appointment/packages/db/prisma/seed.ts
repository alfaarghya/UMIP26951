...
async function main() {
  ...
  const admin2 = await prisma.user.upsert({
    ...
    create: {
      name: "alfaarghya",
      email: "alfaarghyaadmin@stba.com",
      role: "ADMIN",
  ...
  const appointments = await prisma.appointment.createMany({
    data: [
      ...
      },
      {
        ...
        date: new Date("2025-04-16T14:00:00Z"),
        status: "APPROVED",
      },
      {
        studentId: student3.id,
        teacherId: teacher3.id,
        date: new Date("2025-04-18T11:30:00Z"),
        status: "CANCELLED",
      },
      {
      ...
      },
      {
        studentId: student1.id,
        teacherId: teacher3.id,
        date: new Date("2025-04-21T13:00:00Z"),
        status: "APPROVED",
      }
    ]
  });
